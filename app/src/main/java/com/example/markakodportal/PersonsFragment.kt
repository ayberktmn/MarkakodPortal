...
class PersonsFragment : Fragment() {
    ...
    private fun createDummyData(): List<Profile> {
        ...
        dummyData.add(Profile( "Yusuf Albayrak","yusufalbyrk@gmail.com", "Team Lead","https://media.licdn.com/dms/image/C5603AQFJGAtFz2dc-Q/profile-displayphoto-shrink_800_800/0/1546379045773?e=2147483647&v=beta&t=_seM317wOdlQZV4YEoZylDr1v_-YQROeSqchG8m0BV4"))
        dummyData.add(Profile( "Zehra Demircan","zhradmrcn@gmail.com", "Project Manager","https://pps.whatsapp.net/v/t61.24694-24/358498502_1259398768281732_4266850499991214349_n.jpg?ccb=11-4&oh=01_AdQ7Z8AVTUomgVoJOzZewt-KCdi6uf0f0-ghqjZQ4ePCZA&oe=64C7777A"))
    ...
    private fun initRecyclyer(){
        val profileList = createDummyData()

        personsadapter = PersonsAdapter(profileList)
        binding.rcylerPersons.adapter = personsadapter
